...
#define OBD_ERR_COMM_P2_TIMEOUT_MAX_TESTER_ECU (OBD_MAKE_ERROR(SRV_STATUS_COMM, (obd_status_t)0x1U))
#define OBD_ERR_COMM_P2_TIMEOUT_MIN_TESTER_ECU (OBD_MAKE_ERROR(SRV_STATUS_COMM, (obd_status_t)0x2U))
#define OBD_ERR_COMM_P3_TIMEOUT_MAX_ECU_TESTER (OBD_MAKE_ERROR(SRV_STATUS_COMM, (obd_status_t)0x3U))
#define OBD_ERR_COMM_P3_TIMEOUT_MIN_ECU_TESTER (OBD_MAKE_ERROR(SRV_STATUS_COMM, (obd_status_t)0x4U))
