...
#define OBD_ERR_5BAUD_KB1_NOT_RECVD       (OBD_MAKE_ERROR(SRV_STATUS_INIT, (uint16_t)0x3U))
#define OBD_ERR_5BAUD_KB2_NOT_RECVD       (OBD_MAKE_ERROR(SRV_STATUS_INIT, (uint16_t)0x4U))
#define OBD_ERR_5BAUD_SYNC_NOT_RECVD      (OBD_MAKE_ERROR(SRV_STATUS_INIT, (uint16_t)0x5U))
#define OBD_ERR_5BAUD_INV_ADDR_NOT_RECVD  (OBD_MAKE_ERROR(SRV_STATUS_INIT, (uint16_t)0x6U))
#define OBD_ERR_CONN_TIMER_INIT_FAILED    (OBD_MAKE_ERROR(SRV_STATUS_INIT, (uint16_t)0x7U))
#define OBD_ERR_CONN_TRANS_INIT_FAILED    (OBD_MAKE_ERROR(SRV_STATUS_INIT, (uint16_t)0x8U))
